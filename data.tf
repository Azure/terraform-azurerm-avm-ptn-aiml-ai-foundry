...
data "azurerm_key_vault" "existing" {
  count = var.existing_key_vault_resource_id != null && var.existing_key_vault_resource_id != "skip-deployment" ? 1 : 0
...
data "azurerm_cosmosdb_account" "existing" {
  count = var.existing_cosmos_db_resource_id != null && var.existing_cosmos_db_resource_id != "skip-deployment" ? 1 : 0
...
data "azurerm_search_service" "existing" {
  count = var.existing_ai_search_resource_id != null && var.existing_ai_search_resource_id != "skip-deployment" ? 1 : 0

...
# AI Foundry module with CMK encryption and private endpoints
module "ai_foundry" {
  source = "../../"
  ...
  depends_on = [azapi_resource_action.purge_ai_foundry, azurerm_key_vault_key.cmk]
}
...
resource "time_sleep" "purge_ai_foundry_cooldown" {
  destroy_duration = "900s" # 15 minutes
